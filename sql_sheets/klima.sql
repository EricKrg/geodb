...
create table temp_wipperdorf (did bigint, mess_datum bigint, aid int, stations_id float, wasserstand float, durchfluss float); 
create table temp_vacha (did bigint, mess_datum bigint, aid int, stations_id float, wasserstand float, durchfluss float) ;
create table temp_rudolstadt (did bigint, mess_datum bigint, aid int, stations_id float, wasserstand float, durchfluss float);
...
Insert into pegel_messdaten  select did, mess_datum, aid, stations_id, wasserstand, durchfluss  from temp_wipperdorf;
Insert into pegel_messdaten  select did, mess_datum, aid, stations_id, wasserstand, durchfluss  from temp_vacha;
Insert into pegel_messdaten  select did, mess_datum, aid, stations_id, wasserstand, durchfluss  from temp_rudolstadt;
